window.HeadingEntranceSnippet = {
  css: `.heading-entrance {
  position: relative;
  display: inline-flex;
  align-items: center;
...
.heading-entrance__char {
  display: inline-block;
  white-space: pre;
  will-change: filter;
}

/* Blend layers threshold the blurred text back into sharp, "bleeding" shapes. */
.heading-entrance__burn,
.heading-entrance__dodge {
  position: absolute;
  inset: 0;
  pointer-events: none;
}
...
.heading-entrance__dodge {
  ...
  js: `window.initHeadingEntrance = function initHeadingEntrance(root, options = {}) {
