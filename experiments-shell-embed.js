window.EXPERIMENTS_SHELL_HTML = `  <div class="cp-app cp-app--fullscreen">
    ...
    <aside class="panel">
        ...
        <div class="field">
          ...
          <div class="row">
            <div class="input-wrap color-wrap color-selector__wrap">
              ...
              <input type="text" data-color-hex value="F0F0F0" spellcheck="false" aria-label="Hex">
      ...
      <div class="field">
        ...
        <div id="border-color-root">
          <div class="row">
            <div class="input-wrap color-wrap color-selector__wrap">
              <button type="button" class="color-selector__trigger" data-color-trigger aria-haspopup="dialog" aria-expanded="false" aria-label="Open color picker"><span class="swatch" data-color-swatch></span></button>
              <input type="text" data-color-hex value="CCCCCC" spellcheck="false" aria-label="Hex">
              <div class="opacity-wrap">
                <input type="text" data-color-opacity value="100" aria-label="Opacity">
                <span class="opacity-suffix">%</span>
              </div>
        ...
        <div class="field">
          ...
          <div class="row">
            <div class="input-wrap color-wrap color-selector__wrap">
              ...
              <input type="text" data-color-hex value="F0F0F0" spellcheck="false" aria-label="Hex">
              <div class="opacity-wrap">
                <input type="text" data-color-opacity value="90" aria-label="Opacity">
                <span class="opacity-suffix">%</span>
              </div>
              <div class="color-selector__popover" role="dialog" aria-label="Color picker">
                <div class="color-selector__sv" data-color-sv tabindex="0" role="slider" aria-label="Saturation and brightness"><span class="color-selector__thumb"></span></div>
      ...
      <div class="field size-control" id="exp-carousel-rotate-size-root">
        <span class="field-label">Size</span>
        <div class="row">
          <div class="input-wrap">
            <span class="input-icon">W</span>
            <input type="text" data-size-width value="400" inputmode="decimal" aria-label="Width">
          </div>
          <div class="input-wrap">
            <span class="input-icon">H</span>
            <input type="text" data-size-height value="500" inputmode="decimal" aria-label="Height">
          </div>
      ...
      <div id="exp-carousel-rotate-color-1-root">
        <div class="field">
          ...
          <div class="row">
            <div class="input-wrap color-wrap color-selector__wrap">
              <button type="button" class="color-selector__trigger" data-color-trigger aria-haspopup="dialog" aria-expanded="false" aria-label="Open color picker"><span class="swatch" data-color-swatch></span></button>
              <input type="text" data-color-hex value="FF6B6B" spellcheck="false" aria-label="Hex">
              <div class="opacity-wrap">
                <input type="text" data-color-opacity value="100" aria-label="Opacity">
                <span class="opacity-suffix">%</span>
              </div>
      ...
      <div id="exp-carousel-rotate-color-2-root">
        <div class="field">
          ...
          <div class="row">
            <div class="input-wrap color-wrap color-selector__wrap">
              <button type="button" class="color-selector__trigger" data-color-trigger aria-haspopup="dialog" aria-expanded="false" aria-label="Open color picker"><span class="swatch" data-color-swatch></span></button>
              <input type="text" data-color-hex value="4ECDC4" spellcheck="false" aria-label="Hex">
              <div class="opacity-wrap">
                <input type="text" data-color-opacity value="100" aria-label="Opacity">
                <span class="opacity-suffix">%</span>
              </div>
      ...
      <div id="exp-carousel-rotate-color-3-root">
        <div class="field">
          ...
          <div class="row">
            <div class="input-wrap color-wrap color-selector__wrap">
              <button type="button" class="color-selector__trigger" data-color-trigger aria-haspopup="dialog" aria-expanded="false" aria-label="Open color picker"><span class="swatch" data-color-swatch></span></button>
              <input type="text" data-color-hex value="FFE66D" spellcheck="false" aria-label="Hex">
              <div class="opacity-wrap">
                <input type="text" data-color-opacity value="100" aria-label="Opacity">
                <span class="opacity-suffix">%</span>
              </div>
      ...
      <div id="exp-carousel-rotate-color-4-root">
        <div class="field">
          ...
          <div class="row">
            <div class="input-wrap color-wrap color-selector__wrap">
              <button type="button" class="color-selector__trigger" data-color-trigger aria-haspopup="dialog" aria-expanded="false" aria-label="Open color picker"><span class="swatch" data-color-swatch></span></button>
              <input type="text" data-color-hex value="5B8DEF" spellcheck="false" aria-label="Hex">
              <div class="opacity-wrap">
                <input type="text" data-color-opacity value="100" aria-label="Opacity">
                <span class="opacity-suffix">%</span>
              </div>
      ...
      <div id="exp-carousel-rotate-color-5-root">
        <div class="field">
          ...
          <div class="row">
            <div class="input-wrap color-wrap color-selector__wrap">
              <button type="button" class="color-selector__trigger" data-color-trigger aria-haspopup="dialog" aria-expanded="false" aria-label="Open color picker"><span class="swatch" data-color-swatch></span></button>
              <input type="text" data-color-hex value="C77DFF" spellcheck="false" aria-label="Hex">
              <div class="opacity-wrap">
                <input type="text" data-color-opacity value="100" aria-label="Opacity">
                <span class="opacity-suffix">%</span>
              </div>
      ...
      <div class="field size-control" id="exp-carousel-rotate-x-size-root">
        <span class="field-label">Size</span>
        <div class="row">
          <div class="input-wrap">
            <span class="input-icon">W</span>
            <input type="text" data-size-width value="600" inputmode="decimal" aria-label="Width">
          </div>
          <div class="input-wrap">
            <span class="input-icon">H</span>
            <input type="text" data-size-height value="400" inputmode="decimal" aria-label="Height">
          </div>
          <button type="button" class="size-control__lock" data-size-lock aria-pressed="false" aria-label="Lock aspect ratio"><img src="" alt=""></button>
        </div>
      </div>
      ...
      <div class="field size-control" id="exp-carousel-flip-fan-size-root">
        <span class="field-label">Size</span>
        <div class="row">
          <div class="input-wrap">
            <span class="input-icon">W</span>
      ...
      <div class="field size-control" id="exp-carousel-flip-horiz-size-root">
        <span class="field-label">Size</span>
        <div class="row">
          <div class="input-wrap">
            <span class="input-icon">W</span>
      ...
      <div id="exp-transition-arc-scroll-solid-color-root">
        <div class="field">
          ...
          <div class="row">
            <div class="input-wrap color-wrap color-selector__wrap">
              <button type="button" class="color-selector__trigger" data-color-trigger aria-haspopup="dialog" aria-expanded="false" aria-label="Open color picker"><span class="swatch" data-color-swatch></span></button>
              <input type="text" data-color-hex value="CECECE" spellcheck="false" aria-label="Hex">
              <div class="opacity-wrap">
                <input type="text" data-color-opacity value="100" aria-label="Opacity">
                <span class="opacity-suffix">%</span>
              </div>
      ...
      <div class="field size-control" id="exp-parallax-horizontal-size-root">
        <span class="field-label">Card size</span>
        <div class="row">
          <div class="input-wrap">
            <span class="input-icon">W</span>
            <input type="text" data-size-width value="393" inputmode="decimal" aria-label="Width">
          </div>
          <div class="input-wrap">
            <span class="input-icon">H</span>
            <input type="text" data-size-height value="263" inputmode="decimal" aria-label="Height">
          </div>
          <button type="button" class="size-control__lock" data-size-lock aria-pressed="false" aria-label="Lock aspect ratio"><img src="" alt=""></button>
        </div>
      </div>
      ...
      <div class="field multi-image-upload" id="exp-parallax-horizontal-images-root">
        <span class="field-label">Images</span>
        <div class="multi-image-upload__grid" role="list">
          <button type="button" class="multi-image-upload__add" aria-label="Add images" data-tooltip="Add images"><img src="" alt="" data-icon="plus"></button>
          <input type="file" class="upload-file-input" accept="image/png,image/jpeg,image/webp,image/gif" multiple tabindex="-1" aria-hidden="true">
        </div>
