window.EXPERIMENTS_SHELL_HTML = `  <div class="cp-app cp-app--fullscreen">
    <div class="cp-preview-area">
      ...
      <div class="cp-preview" data-experiment-preview="4" hidden>
    ...
    <aside class="panel">
      ...
      <div data-experiment-panel="4" hidden>
      <div class="field">
        <label class="field-label" for="exp4-count">Box Count</label>
        <div class="row">
          <div class="input-wrap input-wrap--label">
            <input type="text" id="exp4-count" value="5">
          </div>
        </div>
      </div>
      ...
      <div class="field">
        ...
        <div class="row">
          <div class="input-wrap input-wrap--label">
            <input type="text" id="exp4-radius" value="0">
          </div>
        </div>
      </div>

      <div id="exp4-color-1-root">
        <div class="field">
          <span class="field-label">Box 1 Color</span>
          <div class="row">
            <div class="input-wrap color-wrap">
      ...
      <div class="field">
        ...
        <div class="row">
          <div class="input-wrap">
            <span class="input-icon input-icon--wide"><img src="data:image/svg+xml;base64," alt=""></span>
            <input type="text" id="exp4-rotate" value="12">
            <div class="suffix-wrap"><span>°</span></div>
          </div>
        </div>
        <div class="row">
          <div class="input-wrap">
            ...
            <input type="text" id="exp4-orbit" value="600">
            <div class="suffix-wrap"><span>px</span></div>
          </div>
        </div>
        <div class="row">
          <div class="input-wrap">
            ...
            <input type="text" id="exp4-perspective" value="1200">
            <div class="suffix-wrap"><span>px</span></div>
          </div>
        </div>
        <div class="row">
          <div class="input-wrap">
            <span class="input-icon"><img src="data:image/svg+xml;base64," alt=""></span>
            <input type="text" id="exp4-duration" value="350">
            <div class="suffix-wrap"><span>ms</span></div>
          </div>
        </div>
        <div class="row">
        ...
        <div class="row">
          <div class="input-wrap input-wrap--label">
            <input type="text" id="exp4-velocity" value="1">
          </div>
        </div>
      </div>

      <div id="exp4-easing-root">
        <div class="field cubic-bezier-field">
          <span class="field-label">Easing</span>
          <div class="cubic-bezier-editor" data-bezier-editor>
            <svg class="cubic-bezier-svg" data-bezier-svg viewBox="0 0 208 200" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
