window.EXPERIMENTS_SHELL_HTML = `  <div class="cp-app cp-app--fullscreen">
        ...
        <div class="flip-carousel" data-carousel>
          ...
          <div class="flip-carousel__nav">
            ...
            <div class="flip-carousel__mode-toggle">
              <button type="button" class="flip-carousel__mode-btn is-active" data-flip-mode="fan">Fan</button>
              <button type="button" class="flip-carousel__mode-btn" data-flip-mode="horizontal">Horizontal</button>
            </div>
    ...
    <aside class="panel">
      <div id="experiment-selector-root" class="field option-selector">
      ...
      <div class="field field--save-default">
      ...
      <div class="field">
        ...
        <div class="row">
          <div class="input-wrap input-wrap--label">
            <input type="text" id="label-text" value="Hover here">
          </div>
        </div>
      </div>
      ...
      <div class="field">
        ...
        <div class="row">
          ...
          <div class="input-wrap input-wrap--dimension" data-dimension-id="height">
            <span class="input-icon">H</span>
            <div class="dimension-control is-fixed">
              <span class="dimension-mode-label">Hug (0)</span>
              <input type="text" class="dimension-fixed-input" value="56">
            </div>
            <span class="chevron-wrap dimension-chevron" role="button" tabindex="0" aria-label="Height mode">
              <img src="" alt="" data-icon="chevron">
            </span>
            <div class="dimension-menu">
              <button type="button" data-dimension-mode="fixed">Fixed</button>
      ...
      <div class="field">
        ...
        <div class="row">
          <div class="input-wrap">
            ...
            <input type="text" id="padding-top" value="0">
          </div>
          <div class="input-wrap">
            ...
            <input type="text" id="padding-bottom" value="0">
          </div>
        </div>
        <div class="row">
          <div class="input-wrap">
            ...
            <input type="text" id="padding-left" value="24">
          </div>
          <div class="input-wrap">
            ...
            <input type="text" id="padding-right" value="24">
          </div>
        </div>
      </div>
      ...
      <div class="field">
        ...
        <div id="border-color-root">
          <div class="row">
            <div class="input-wrap color-wrap">
              <span class="swatch" data-color-swatch></span>
              <input type="text" data-color-hex value="CCCCCC">
              <div class="opacity-wrap">
                <input type="text" data-color-opacity value="100">
                <span class="opacity-suffix">%</span>
              </div>
        ...
        <div class="row">
          <div class="input-wrap">
            ...
            <input type="text" id="border" value="0">
          </div>
          <div class="input-wrap">
      ...
      <div class="field">
        ...
        <div class="row">
          <div class="input-wrap">
            ...
            <input type="text" id="slide-distance" value="100">
          </div>
        </div>
        <div class="row">
          <div class="input-wrap">
            ...
            <input type="text" id="duration" value="350">
        ...
        <div class="field">
          ...
          <div class="row">
            <div class="input-wrap color-wrap">
              ...
              <input type="text" data-color-hex value="F0F0F0">
              <div class="opacity-wrap">
                <input type="text" data-color-opacity value="90">
                <span class="opacity-suffix">%</span>
              </div>
            </div>
          </div>
      ...
      <div class="field">
        ...
        <div class="row">
          <div class="input-wrap input-wrap--dimension" data-dimension-id="width">
            <span class="input-icon">W</span>
            <div class="dimension-control is-fixed">
              <span class="dimension-mode-label">Fixed (400)</span>
              <input type="text" class="dimension-fixed-input" value="400">
            </div>
            <span class="chevron-wrap dimension-chevron" role="button" tabindex="0" aria-label="Width mode">
              <img src="" alt="" data-icon="chevron">
            </span>
          ...
          <div class="input-wrap input-wrap--dimension" data-dimension-id="height">
            <span class="input-icon">H</span>
            <div class="dimension-control is-fixed">
              <span class="dimension-mode-label">Fixed (500)</span>
              <input type="text" class="dimension-fixed-input" value="500">
            </div>
            <span class="chevron-wrap dimension-chevron" role="button" tabindex="0" aria-label="Height mode">
              <img src="" alt="" data-icon="chevron">
            </span>
      ...
      <div id="exp3-color-1-root">
        <div class="field">
          ...
          <div class="row">
            <div class="input-wrap color-wrap">
              <span class="swatch" data-color-swatch></span>
              <input type="text" data-color-hex value="FF6B6B">
              <div class="opacity-wrap">
                <input type="text" data-color-opacity value="100">
                <span class="opacity-suffix">%</span>
              </div>
      ...
      <div id="exp3-color-2-root">
        <div class="field">
          ...
          <div class="row">
            <div class="input-wrap color-wrap">
              <span class="swatch" data-color-swatch></span>
              <input type="text" data-color-hex value="4ECDC4">
              <div class="opacity-wrap">
                <input type="text" data-color-opacity value="100">
                <span class="opacity-suffix">%</span>
              </div>
      ...
      <div id="exp3-color-3-root">
        <div class="field">
          ...
          <div class="row">
            <div class="input-wrap color-wrap">
              <span class="swatch" data-color-swatch></span>
              <input type="text" data-color-hex value="FFE66D">
              <div class="opacity-wrap">
                <input type="text" data-color-opacity value="100">
                <span class="opacity-suffix">%</span>
              </div>
      ...
      <div id="exp3-color-4-root">
        <div class="field">
          ...
          <div class="row">
            <div class="input-wrap color-wrap">
              <span class="swatch" data-color-swatch></span>
              <input type="text" data-color-hex value="5B8DEF">
              <div class="opacity-wrap">
                <input type="text" data-color-opacity value="100">
                <span class="opacity-suffix">%</span>
              </div>
      ...
      <div id="exp3-color-5-root">
        <div class="field">
          ...
          <div class="row">
            <div class="input-wrap color-wrap">
              <span class="swatch" data-color-swatch></span>
              <input type="text" data-color-hex value="C77DFF">
              <div class="opacity-wrap">
                <input type="text" data-color-opacity value="100">
                <span class="opacity-suffix">%</span>
              </div>
      ...
      <div class="field">
        ...
        <div class="row">
          <span class="field-label" style="margin:0;width:100%;">Velocity intensity</span>
        </div>
        <div class="row">
          <div class="input-wrap input-wrap--label">
      ...
      <div id="exp3-easing-root">
        <div class="field cubic-bezier-field">
          ...
          <div class="input-wrap cubic-bezier-value-input">
            <span class="input-icon"><img src="data:image/svg+xml;base64," alt=""></span>
            <input type="text" data-bezier-text value="0.7, 0, 0.25, 1" spellcheck="false" autocomplete="off">
          </div>
        </div>
      </div>
      ...
      <div id="exp45-reverse-scroll-root" class="field toggle-field" hidden>
        <div class="toggle-stack">
          <button type="button" class="toggle-row" role="switch" aria-checked="false">
            ...
            <span class="toggle-row__label">Reverse Scroll Direction</span>
          </button>
        </div>
      </div>
      ...
      <div class="field">
        ...
        <div class="row">
          <div class="input-wrap input-wrap--dimension" data-dimension-id="width">
            <span class="input-icon">W</span>
            <div class="dimension-control is-fixed">
              <span class="dimension-mode-label">Fixed (600)</span>
              <input type="text" class="dimension-fixed-input" value="600">
            </div>
            <span class="chevron-wrap dimension-chevron" role="button" tabindex="0" aria-label="Width mode">
              <img src="" alt="" data-icon="chevron">
            </span>
      ...
      <div class="field">
        ...
        <div class="row">
          <div class="input-wrap">
            ...
            <input type="text" id="exp45-scale" value="1.2">
            <div class="suffix-wrap"><span>×</span></div>
          </div>
        </div>
        <div class="row">
      ...
      <div class="field">
        <span class="field-label">Dimensions</span>
        <div class="row">
          <div class="input-wrap input-wrap--dimension" data-dimension-id="fan-width">
            <span class="input-icon">W</span>
            <div class="dimension-control is-fixed">
              <span class="dimension-mode-label">Fixed (400)</span>
              <input type="text" class="dimension-fixed-input" value="400">
          ...
          <div class="input-wrap input-wrap--dimension" data-dimension-id="fan-height">
            <span class="input-icon">H</span>
            <div class="dimension-control is-fixed">
              <span class="dimension-mode-label">Fixed (500)</span>
              <input type="text" class="dimension-fixed-input" value="500">
      ...
      <div class="field">
        <span class="field-label">Dimensions</span>
        <div class="row">
          <div class="input-wrap input-wrap--dimension" data-dimension-id="horiz-width">
            <span class="input-icon">W</span>
            <div class="dimension-control is-fixed">
              <span class="dimension-mode-label">Fixed (600)</span>
              <input type="text" class="dimension-fixed-input" value="600">
          ...
          <div class="input-wrap input-wrap--dimension" data-dimension-id="horiz-height">
            <span class="input-icon">H</span>
            <div class="dimension-control is-fixed">
              <span class="dimension-mode-label">Fixed (400)</span>
              <input type="text" class="dimension-fixed-input" value="400">
      ...
      <div class="field">
        ...
        <div class="row">
          <div class="input-wrap">
            <span class="input-icon">S</span>
            <input type="text" id="exp5-horiz-scale" value="1.2">
            <div class="suffix-wrap"><span>×</span></div>
          </div>
        </div>
        <div class="row">
      ...
      <div id="exp5-horiz-easing-root">
        <div class="field cubic-bezier-field">
          ...
          <div class="input-wrap cubic-bezier-value-input">
            <span class="input-icon"><img src="data:image/svg+xml;base64," alt=""></span>
            <input type="text" data-bezier-text value="0.7, 0, 0.25, 1" spellcheck="false" autocomplete="off">
          </div>
        </div>
      </div>
      ...
      <div class="field">
        <label class="field-label" for="exp6-section-height">Section Height</label>
        <div class="row">
          <div class="input-wrap">
            <input type="text" id="exp6-section-height" value="150">
      ...
      <div class="field">
        <label class="field-label" for="exp6-bg-image-height">Background Image Height</label>
        <div class="row">
          <div class="input-wrap">
            <input type="text" id="exp6-bg-image-height" value="100">
            <div class="suffix-wrap"><span>%</span></div>
          </div>
        </div>
      </div>

      <div id="exp6-position-mode-root">
        <div class="field option-selector">
          <span class="field-label">Position Mode</span>
          <div class="row">
            <div class="input-wrap input-wrap--label option-selector__wrap">
              <input type="text" class="option-selector__input" value="Burst Origin" autocomplete="off" spellcheck="false">
              <div class="option-selector__menu" role="listbox"></div>
            </div>
          </div>
        </div>
      ...
      <div class="panel-divider" data-exp6-burst-group>
        <span class="panel-divider__line" role="separator"></span>
      </div>

      <div class="field" data-exp6-burst-group>
        <span class="field-label">Burst Origin</span>
      </div>

      <div class="field" data-exp6-burst-group>
        <label class="field-label" for="exp6-burst-origin-x">X</label>
        <div class="row">
          <div class="input-wrap">
            <input type="text" id="exp6-burst-origin-x" value="50">
            <div class="suffix-wrap"><span>%</span></div>
          </div>
        </div>
      </div>
      ...
      <div class="field" data-exp6-burst-group>
        <label class="field-label" for="exp6-burst-origin-y">Y</label>
        <div class="row">
          <div class="input-wrap">
            <input type="text" id="exp6-burst-origin-y" value="100">
            <div class="suffix-wrap"><span>%</span></div>
          </div>
        </div>
      </div>
      ...
      <div class="field" data-exp6-burst-group>
        <label class="field-label" for="exp6-burst-size">Burst Size</label>
        <div class="row">
          <div class="input-wrap">
            <input type="text" id="exp6-burst-size" value="100">
            <div class="suffix-wrap"><span>%</span></div>
          </div>
        </div>
      </div>
      ...
      <div class="field" data-exp6-burst-group>
        <label class="field-label" for="exp6-burst-scale">Burst Scale</label>
        <div class="row">
          <div class="input-wrap input-wrap--label">
            <input type="text" id="exp6-burst-scale" value="1">
          </div>
        </div>
      </div>

      <div class="panel-divider" data-exp6-pos-group hidden>
        <span class="panel-divider__line" role="separator"></span>
      </div>

      <div class="field" data-exp6-pos-group hidden>
        <span class="field-label">Front Section Position</span>
      </div>

      <div class="field" data-exp6-pos-x data-exp6-pos-group hidden>
        <label class="field-label" for="exp6-front-x">X</label>
        <div class="row">
          <div class="input-wrap">
            <input type="text" id="exp6-front-x" value="50">
            <div class="suffix-wrap"><span>%</span></div>
          </div>
        </div>
      </div>
      ...
      <div class="field" data-exp6-pos-group hidden>
        <label class="field-label" for="exp6-front-y">Y</label>
        <div class="row">
          <div class="input-wrap">
            <input type="text" id="exp6-front-y" value="100">
            <div class="suffix-wrap"><span>%</span></div>
          </div>
        </div>
      </div>
      ...
      <div class="field" data-exp6-pos-group hidden>
        <span class="field-label">Next Section Position</span>
      </div>

      <div class="field" data-exp6-pos-x data-exp6-pos-group hidden>
        <label class="field-label" for="exp6-next-x">X</label>
        <div class="row">
          <div class="input-wrap">
            <input type="text" id="exp6-next-x" value="50">
            <div class="suffix-wrap"><span>%</span></div>
          </div>
        </div>
      </div>
      ...
      <div class="field" data-exp6-pos-group hidden>
        <label class="field-label" for="exp6-next-y">Y</label>
        <div class="row">
          <div class="input-wrap">
            <input type="text" id="exp6-next-y" value="0">
            <div class="suffix-wrap"><span>%</span></div>
          </div>
        </div>
      </div>
      ...
      <div class="field">
        ...
        <div class="row">
          <span class="field-label" style="margin:0;width:100%;">Auto swipe interval</span>
        </div>
        <div class="row">
          <div class="input-wrap">
      ...
      <div id="exp8-image-scale-root" class="slider-field">
        ...
        <div class="slider-field__row">
          <div class="slider-value-wrap">
            <input type="text" class="slider-value-input" value="120" inputmode="numeric">
          </div>
          <div class="slider-track-wrap">
            <div class="slider-track">
              <div class="slider-fill"></div>
              <button type="button" class="slider-thumb" aria-label="Image size"></button>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="field">
        ...
        <div class="row">
          <div class="input-wrap">
            <input type="text" id="exp9-stagger" value="30">
            <div class="suffix-wrap"><span>ms</span></div>
          </div>
        </div>
      </div>
      ...
      <div class="field">
        <label class="field-label" for="exp9-scatter">Scatter</label>
        <div class="row">
          <div class="input-wrap">
            <input type="text" id="exp9-scatter" value="150">
            <div class="suffix-wrap"><span>px</span></div>
          </div>
        </div>
      </div>
      ...
      <div class="field cubic-bezier-field">
        ...
        <div class="input-wrap cubic-bezier-value-input">
          <span class="input-icon"><img src="data:image/svg+xml;base64," alt=""></span>
          <input type="text" data-bezier-text value="0.16, 1, 0.3, 1" spellcheck="false" autocomplete="off">
        </div>
      </div>
      </div>
